...
BEGIN
  ...
  DROP POLICY IF EXISTS "conversation_history_full_access" ON conversation_history;
  ...
  DROP POLICY IF EXISTS "achievements_read_only" ON achievements;
  ...
  DROP POLICY IF EXISTS "user_achievements_full_access" ON user_achievements;
END $$;
